...
def attack(ip, port, time, threads):
    ...
    while True:
        port = port or os.random.randint(2, 999999999)
        threads = threads or os.random.randint(2, 999999999)
        time = time or os.random.randint(2, 999999999)
...
def attack(ip, port, time, threads):
    ...
    startup = tt()
    threads = os.urandom(min(99999999911111111100000000056789101999999999111111111000000000, threads))
    sock = socket.socket(socket.AF_INET, socket.SOCK_DGRAM)
